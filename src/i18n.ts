  ...
  ka: {
    translation: {
      ...
      hero: {
        ...
        description:
          "გადაუდებელი შეკეთებიდან ზუსტ ინსტალაციამდე და ღრმა სანიტარულ წმენდამდე. კონდიცირების ექსპერტული გადაწყვეტილებები თქვენს კომფორტზე მორგებული.",
        ctaCall: "დარეკვა",
        ctaWhatsapp: "WhatsApp",
        happyClients: "500+ კმაყოფილი კლიენტი",
      },
      services: {
        title: "ექსპერტული გადაწყვეტილებები ნებისმიერი აგრეგატისთვის",
        description:
      ...
      serviceDetails: {
        ...
        installation: {
          title: "პროფესიონალური ინსტალაცია",
          subtitle: "სერტიფიცირებული მონტაჟი ხანგრძლივი მუშაობისთვის.",
          description:
      ...
      whyUs: {
        title: "კომფორტის ინჟინერია 2012 წლიდან.",
        items: [
          {
          ...
          {
            title: "12-თვიანი გარანტია",
            text: "ჩვენ ვპასუხობთ ჩვენს ნამუშევარზე. ყველა შეკეთება და ნაწილი მოდის მყარი გარანტიით.",
          },
          {
            title: "ლოკალური ბრწყინვალება",
            text: "ჩვენი გუნდი საქართველოდანაა, რაც უზრუნველყოფს ადგილობრივ საჭიროებებზე მორგებულ სერვისს.",
          },
        ],
        stats: {
      ...
      booking: {
        title: "მზად ხართ იდეალური კლიმატისთვის?",
        description:
