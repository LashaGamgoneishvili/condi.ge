        ...
        <div className="mt-12 grid md:grid-cols-1 gap-8 items-start">
          <div>
            <p className="text-lg mb-4">
              🔧 <strong>წმენდა</strong>
              კონდიციონერის რეგულარული გაწმენდა აუცილებელია ჰაერის ხარისხის,
              ენერგოეფექტურობისა და მოწყობილობის ხანგრძლივ მუშაობის
              უზრუნველსაყოფად. ვასუფთავებთ ფილტრებს, ორთქლის გამცივრებელს და
              დრენაჟის სისტემას სპეციალური საშუალებებით, რაც ხელს უშლის მტვრის,
              სოკოსა და ბაქტერიების დაგროვებას.
            </p>
