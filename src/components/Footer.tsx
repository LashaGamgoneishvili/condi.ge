...
const Footer = () => {
  return (
    <footer className="bg-gray-100 text-gray-900 mt-12">
      <section className="bg-gradient-to-tr from-[#474a9d] to-blue-500 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold mb-6">დაგვიკავშირდით დღესვე</h2>
          <p className="text-lg mb-8 opacity-90">
            24/7 ხელმისაწვდომი სერვისი თბილისსა და რუსთავში
          </p>
      ...
      <div className="bg-gray-800 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-400">
            ...
            დაცულია ( Air conditioner service. All rights reserved.)
          </p>
        </div>
      </div>
    </footer>
