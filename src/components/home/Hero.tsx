        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-900 leading-[1.05] mb-8 uppercase tracking-tight">
              {t('hero.title')} <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-accent-teal">{t('hero.subtitle')}</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a href="tel:+9955550199" className="px-8 py-4 bg-primary-600 text-white rounded-2xl font-bold text-lg hover:bg-primary-700 transition-all shadow-xl shadow-primary-200/50 flex items-center justify-center gap-2 group uppercase tracking-wide">
                <Phone size={22} />
                {t('hero.ctaCall')}
                <ArrowRight className="group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="https://wa.me/9955550199" className="px-8 py-4 bg-white text-green-600 border border-green-200 rounded-2xl font-bold text-lg hover:border-green-300 hover:bg-green-50 transition-all flex items-center justify-center gap-3 shadow-sm uppercase tracking-wide">
            ...
            <div className="mt-12 flex flex-col sm:flex-row items-center gap-6 sm:gap-8 justify-center lg:justify-start">
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-xs lg:text-sm font-semibold text-slate-600 uppercase tracking-widest">{t('hero.happyClients')}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative z-10 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary-900/10 border-8 border-white/40 backdrop-blur-sm">
              ...
              <div className="absolute bottom-8 left-8 bg-white/60 backdrop-blur-md p-4 rounded-2xl shadow-xl flex items-center gap-4 border border-white/50">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-500 uppercase tracking-wider">Fastest Response</p>
                  <p className="text-lg font-bold text-slate-900">Under 60 Mins</p>
                </div>
              </div>
            </div>
            {/* Background Shapes */}
