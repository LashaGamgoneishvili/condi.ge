...
export const ServiceDetailPage: React.FC = () => {
  ...
  if (!serviceId || !['cleaning', 'installation', 'repair'].includes(serviceId)) {
    return <div className="pt-40 text-center font-bold uppercase tracking-widest text-slate-400 min-h-[60vh] flex items-center justify-center">Service not found.</div>;
  }
    ...
    <div className="pt-28 md:pt-32 pb-24 max-w-7xl mx-auto px-6 relative z-10 min-h-screen">
      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl font-bold text-primary-600 mb-8 uppercase tracking-widest leading-none">
          ...
          <div className="glass p-6 sm:p-8 rounded-[2rem] mb-12 border-white/50 text-left">
            ...
            <ul className="grid sm:grid-cols-2 gap-4">
              {(t(`serviceDetails.${serviceId}.points`, { returnObjects: true }) as string[]).map((point, i) => (
                <li key={i} className="flex items-center gap-3 text-slate-600 font-bold uppercase tracking-wide text-[10px] sm:text-xs">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <a href="tel:+9955550199" className="px-8 py-5 bg-primary-600 text-white rounded-2xl font-black text-lg hover:bg-primary-700 hover:scale-[1.02] transition-all shadow-xl shadow-primary-500/20 flex items-center justify-center gap-3 group uppercase tracking-widest leading-none">
              <Phone size={22} className="group-hover:rotate-12 transition-transform" />
              {t('serviceDetails.bookService')}
            </a>
            <a href="https://wa.me/9955550199" className="px-8 py-5 bg-white text-green-600 border-2 border-green-100 rounded-2xl font-black text-lg hover:border-green-300 hover:bg-green-50 hover:scale-[1.02] transition-all flex items-center justify-center gap-3 shadow-sm uppercase tracking-widest leading-none">
        ...
        >
          <div className="rounded-[2rem] sm:rounded-[3rem] overflow-hidden shadow-2xl border-4 sm:border-8 border-white/40 backdrop-blur-sm">
            <img 
              src={config?.image} 
